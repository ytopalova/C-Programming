...
public class HelloJava{
    ...
    public HelloJava() { 
        ...
        JTextField timeBefAfter = new JTextField(10); 
        timeBefAfter.setEditable(false); 
        gbc.gridy = 5;
        gbc.gridx = 2;
        frame.add(timeBefAfter, gbc);
        ...
        timeBefAfter.setText(Long.toString(timeAfter - timeBefore));
        });
